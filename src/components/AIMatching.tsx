            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-200">
              ...
              {!isMatching && matchResults.length === 0 && (
                <button
                  ...
                  className="w-full flex items-center justify-center space-x-2 px-6 py-4 bg-primary text-white rounded-xl hover:bg-primary-hover transition-all duration-200 transform hover:scale-105 font-semibold"
                >
              ...
              {matchResults.length > 0 && (
                <div className="space-y-4">
                  ...
                  <button
                    onClick={startMatching}
                    className="w-full px-6 py-3 bg-white text-primary border-2 border-primary-light rounded-xl hover:bg-blue-50 hover:border-primary transition-colors font-semibold"
                  >
                    Run New Match
                  </button>
                </div>
                ...
                {matchResults.map((match) => (
                  ...
                  >
                    ...
                    <div className="flex space-x-3">
                      <button className="flex-1 px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-hover transition-all duration-200 font-medium">
                        View Details
                      </button>
