            ...
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                {isAuthenticated ? (
                  <a
                    href="/dashboard"
                    className="group flex items-center justify-center px-8 py-4 bg-primary text-white rounded-xl hover:bg-primary-hover transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                  ...
                  <>
                    ...
                    <button
                      ...
                      className="flex items-center justify-center px-8 py-4 bg-white text-gray-700 rounded-xl border-2 border-gray-200 hover:border-primary hover:text-primary transition-all duration-200 transform hover:scale-105 shadow-sm hover:shadow-md"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="w-48 h-2 bg-gray-200 rounded-full">
                          <div className="w-3/4 h-2 bg-secondary rounded-full"></div>
                        </div>
                      </div>
                    </div>
