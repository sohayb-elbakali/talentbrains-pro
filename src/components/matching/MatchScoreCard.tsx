        ...
        <div className="bg-gradient-to-r from-purple-50 to-blue-50 p-4 border-b-2 border-gray-100">
          <div className="flex items-start gap-3">
            <div className="relative flex-shrink-0">
              ...
              <div className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full ${getScoreColor(match.match_score)} border-2 border-white flex items-center justify-center`}>
                <span className="text-xs font-bold">{Math.round(match.match_score)}</span>
              </div>
            </div>
            <div className="flex-1 min-w-0">
              ...
              {talentInfo.years_of_experience !== undefined && (
                <p className="text-xs text-gray-500 flex items-center gap-1 mt-1">
                  ...
                  {talentInfo.years_of_experience} years exp • {talentInfo.experience_level}
                </p>
              )}
            </div>
          </div>
